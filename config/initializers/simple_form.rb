...
SimpleForm.setup do |config|
  ...
  config.wrappers :default do |b|
    ...
    # b.optional :readonly
    #
    # b.use :label, class: "block text-sm font-medium text-blue font-bold uppercase"
    # b.use :input,
    #       class: 'appearance-none block w-full p-3 border border-blue rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-yellow focus:border-yellow sm:text-sm',
  ...
  config.wrappers :append_string, tag: 'div', class: '', error_class: 'has-errors', valid_class: 'is_valid' do |b|
    # b.use :html5
    # b.use :placeholder
    # b.optional :maxlength
    # b.optional :minlength
  ...
  config.default_form_class = 'grid gap-6'
  ...
  config.country_priority = %w[FR DE BE CH ES NL GB]
